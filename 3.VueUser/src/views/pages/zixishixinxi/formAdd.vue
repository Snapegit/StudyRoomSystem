			...
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="自习室介绍" prop="zixishijieshao">
						<editor class="list_editor" :value="form.zixishijieshao" placeholder="请输入自习室介绍" :readonly="!isAdd||disabledForm.zixishijieshao?true:false"
							@change="(e)=>editorChange(e,'zixishijieshao')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.zixishijieshao = res.data.data.zixishijieshao.replace(reg,'../../../cl78696306/file');
